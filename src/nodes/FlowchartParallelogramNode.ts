...
export class FlowchartParallelogramNode extends FlowchartShapeNode {
    readonly typeId = 'flowchart-parallelogram';
    readonly displayName = 'Parallelogram';
    ...
    async evaluate(inputs: Record<string, any>, properties: Record<string, any>): Promise<Record<string, any>> {
        ...
        const shape = {
            ...
            borderColor: properties['borderColor'] || '#3693AB',
